...
本目录是 Chiral 的设计文档集合。建议阅读顺序：

1. [architecture.md](architecture.md) — 架构总览与术语
2. [communication.md](communication.md) — Core↔Agent 通信协议（方案 A）
...
> 文档随设计推进持续更新。凡标注「待议 / 参考稿」的部分尚未定稿。权威的**已定决策以根 [`CLAUDE.md`](../CLAUDE.md) 为准**。
